...
const benefits = [
  "100 pontos de boas-vindas no Clube Fidelidade",
  "Acesso ao sistema de cashback e benefícios",
...
export default function RegisterPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="relative z-10 w-full max-w-4xl grid lg:grid-cols-2 gap-10 items-center">
        {/* Left — Benefits */}
        <motion.div
        ...
        >
          ...
          <h2 className="text-4xl font-black text-[var(--color-text-primary)] mb-4 leading-tight">
            Faça parte do<br />
            <span className="text-neon">clube premium</span>
          </h2>
          <p className="text-[var(--color-text-secondary)] mb-8">
            Junte-se a milhares de apreciadores e desfrute de benefícios exclusivos.
          </p>
        ...
        >
          <div className="flex flex-col items-center mb-6 lg:hidden">
            <div className="mb-3">
              <Logo variant="black" size="sm" asLink={false} />
            </div>
          ...
          <p className="text-center text-sm text-[var(--color-text-muted)] mt-6">
            Já tem uma conta?{" "}
            <Link href="/login" className="text-[var(--color-neon-blue)] hover:underline font-medium">
              Entrar
            </Link>
          </p>
        </motion.div>
